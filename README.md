...
- **Racha**: días "cumplidos" consecutivos, en días (ejercicios marcados ≥ una regla editable en Ajustes, 3 por defecto). El corte ya no es día por día: una semana (lun–sáb, domingo nunca cuenta) necesita **al menos N días cumplidos** (otra regla editable, 5 por defecto) para no romper la racha — si los alcanza, todos sus días cumplidos suman normal; si no, la racha se corta ahí aunque algún día suelto sí haya llegado al mínimo. La semana en curso nunca se juzga como "rota" hasta que termine. Desde 1.57.0 vive en su propia card en Semana → Resumen (antes estaba en el header, visible en las 6 pantallas): número grande, una sola medalla (bronce/plata/oro a 7/30/100 días — solo la más alta ya ganada, del alto del número), mejor racha y cuánto falta para la siguiente medalla ("Faltan N días para la medalla de…").
- **Semana tiene 2 pestañas** (`.seg-tabs`; ver ADR 0012, ADR 0014 y ADR 0015): **Resumen** (la que abre por default — riel de semanas, riel de días, card de racha, comparación semanal, nota de la semana, eliminar semana) y **Hoy** (selector de día compacto, sesión, panel del día — lo que se toca mientras se entrena). Tocar un día puntual del riel de Resumen manda a Hoy con ese día cargado; tocar una semana se queda en Resumen.
- **Selector de día compacto** (pestaña Hoy): flechas ‹ › + fecha, en vez de un riel de 7 tabs (que ahora vive en Resumen, con Lun–Vie repartiendo el ancho real del riel en cualquier celular y Sáb/Dom revelados solo al hacer scroll horizontal). Los días se pintan en verde cuando quedaron "cumplidos"; uno que recibió contenido migrado de otro muestra un pequeño ícono con el día de origen. Cambiar de día también funciona deslizando el panel a los lados (mismo movimiento, `stepActiveDay()`).
- **Panel del día** (pestaña Hoy):
  ...
  - Card "Iniciar/Finalizar entrenamiento": botón de ícono play/stop en rojo (no texto) + hora de inicio/fin + duración calculada, los 4 en una sola fila sin partirse aunque el celular sea angosto. Posición fija arriba de la tabla de ejercicios, para cualquier día.
...
- Pestaña Resumen: **riel de semanas** (con "+ Nueva semana"), **riel de días**, **card de racha** (número + medallas + mejor racha), **comparación semanal**, **nota libre de la semana** (textarea, se guarda sola al salir del campo) y **eliminar esta semana** (enlace ghost, con doble confirmación).
  - Botón "Compartir resumen semanal" (ícono, en la card de racha): clona el bloque de Resumen (header, riel de semanas, riel de días, card de racha y comparación semanal — esta última solo si está visible) y lo copia al portapapeles como PNG, sin importar qué pestaña (Hoy/Resumen) esté activa en ese momento. "Patrón Strava": una sola card redondeada al 50% de opacidad (no transparente del todo, tampoco sólida) en vez de fondo completamente transparente — pensada para pegarse sobre cualquier fondo al compartir en redes (una foto, no solo un chat oscuro). El título, el subtítulo y el nombre/grupo muscular de cada day-tab van en blanco; los días completados llevan verde al 30%. La card de racha no necesita ese forzado de color — es una `.card` con fondo propio, se lee igual que en la app. El riel de semanas y el de días solo muestran ítems completos —nunca uno cortado a la mitad— y ambos ocupan el ancho real de la card exportada (520px) en vez de quedar encogidos al ancho más angosto del celular de origen: el de días reparte ese ancho entre los tabs que entran, y el de semanas suma tantos pills como quepan. Si el navegador no soporta copiar imágenes, cae a descarga normal.
