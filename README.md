...
- **Panel del día**:
  ...
  - Botón de calendario junto al anterior: clona el bloque de arriba de "Hoy" (header con racha, riel de semanas, riel de días, tira de resumen y comparación semanal) y lo copia al portapapeles como PNG. "Patrón Strava": una sola card sólida y redondeada (esquinas transparentes, resto opaco) en vez de fondo transparente completo — pensada para pegarse sobre cualquier fondo al compartir en redes (una foto, no solo un chat oscuro), ya que el título y los labels sueltos quedaban ilegibles sin nada detrás. Si el navegador no soporta copiar imágenes, cae a descarga normal.
