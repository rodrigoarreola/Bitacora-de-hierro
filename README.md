...
- **Panel del día** (pestaña Hoy):
  ...
  - Ejercicios editables inline: nombre (con autocompletado contra la librería), kg, reps, series — 7 controles siempre visibles por fila (check, nombre+nota, kg, rep, ser, chevron, asa de arrastre).
  ...
  - Conversor kg ⇄ lbs: colapsado detrás de un ícono junto al selector de día — se abre como sheet, no siempre visible.
